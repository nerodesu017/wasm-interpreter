...
fn table_init_31_test() {
  ...
  (module
    ...
    (func (export "test")
      ...
      let wasm_bytes = wat::parse_str(w).unwrap();
      assert!(matches!(validate(&wasm_bytes).err().unwrap(), Error::InvalidValidationStackValType(_)));
}
...
(module
  ...
  (func (export "run") (param $offs i32) (param $len i32)
    (table.init 0 (local.get $offs) (i32.const 0) (local.get $len))))
      ...
      assert!(inst.invoke::<(i32, i32), ()>(run, (24, 16)).err().unwrap() == RuntimeError::TableAccessOutOfBounds);
      for i in 0..32 {
        assert!(inst.invoke::<i32, i32>(test, i).err().unwrap() == RuntimeError::UninitializedElement);
      }
}
...
(module
  ...
  (func (export "run") (param $offs i32) (param $len i32)
    (table.init 0 (local.get $offs) (i32.const 0) (local.get $len))))
      ...
      let run = get_func!(inst, "run");
      let test = get_func!(inst, "test");
      assert!(inst.invoke::<(i32, i32), ()>(run, (25, 16)).err().unwrap() == RuntimeError::TableAccessOutOfBounds);
      for i in 0..32 {
        assert!(inst.invoke::<i32, i32>(test, i).err().unwrap() == RuntimeError::UninitializedElement);
      }
}
...
(module
  ...
  (func (export "run") (param $offs i32) (param $len i32)
    (table.init 0 (local.get $offs) (i32.const 0) (local.get $len))))
      ...
      let run = get_func!(inst, "run");
      let test = get_func!(inst, "test");
      assert!(inst.invoke::<(i32, i32), ()>(run, (96, 32)).err().unwrap() == RuntimeError::TableAccessOutOfBounds);
      for i in 0..160 {
        assert!(inst.invoke::<i32, i32>(test, i).err().unwrap() == RuntimeError::UninitializedElement);
      }
}
...
(module
  ...
  (func (export "run") (param $offs i32) (param $len i32)
    (table.init 0 (local.get $offs) (i32.const 0) (local.get $len))))
      ...
      let run = get_func!(inst, "run");
      let test = get_func!(inst, "test");
      assert!(inst.invoke::<(i32, i32), ()>(run, (97, 31)).err().unwrap() == RuntimeError::TableAccessOutOfBounds);
      for i in 0..160 {
        assert!(inst.invoke::<i32, i32>(test, i).err().unwrap() == RuntimeError::UninitializedElement);
      }
}
...
(module
  ...
  (func (export "run") (param $offs i32) (param $len i32)
    (table.init 0 (local.get $offs) (i32.const 0) (local.get $len))))
      ...
      let run = get_func!(inst, "run");
      let test = get_func!(inst, "test");
      assert!(inst.invoke::<(i32, u32), ()>(run, (48, 4294967280_u32)).err().unwrap() == RuntimeError::TableAccessOutOfBounds);
      for i in 0..64 {
        assert!(inst.invoke::<i32, i32>(test, i).err().unwrap() == RuntimeError::UninitializedElement);
      }
}
...
(module
  ...
  (func (export "run") (param $offs i32) (param $len i32)
    (table.init 0 (local.get $offs) (i32.const 8) (local.get $len))))
      ...
      let run = get_func!(inst, "run");
      let test = get_func!(inst, "test");
      assert!(inst.invoke::<(i32, i32), ()>(run, (0, 4294967292_u32 as i32)).err().unwrap() == RuntimeError::TableAccessOutOfBounds);
      for i in 0..16 {
        assert!(inst.invoke::<i32, i32>(test, i).err().unwrap() == RuntimeError::UninitializedElement);
      }
}
